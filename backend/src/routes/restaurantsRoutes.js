 ...
 *                   example: "Server error. Please try again later."
 */
router.get('/:restaurant_id', restaurantsController.getRestaurantById);
 ...
 *                   example: "Server error. Please try again later."
 */
router.post('/', authenticateToken, restaurantsController.createRestaurant);
 ...
 *                   example: "Server error. Please try again later."
 */
router.put('/:restaurant_id', [authenticateToken, validateUUID], restaurantsController.updateRestaurant);
 ...
 *                   example: "Server error. Please try again later."
 */
router.delete('/:restaurant_id', authenticateToken, restaurantsController.deleteRestaurant);
